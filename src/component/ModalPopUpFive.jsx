...
export default function ModalPopUpFive() {
  return (
    <div className='h-[1000px] w-full bg-black  py-20 flex items-center justify-center '>
            <div className='w-[720px] h-[600px] bg-white px-10 py-8 rounded '>
                ...
                <div className='flex space-x-8 py-4 opacity-70'>
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <select type="text" name="first_name" id="first_name" autocomplete="given-name" placeholder="Enrollment Intelligence" class="mt-2 py-1 border border-black p-2 focus:ring-gray-500 focus:border-gray-500 block w-full shadow-lg xl:text-xl  border-black-400 bg-gray-200 px-36" ></select>
                    </div>

                    <div class="col-span-6 sm:col-span-3">
                        <label for="last_name" class="block text-sm  font-medium text-gray-700">Sub-Category</label>
                        <select type="text" name="last_name" id="last_name" autocomplete="family-name" placeholder="Enrollment Trends New" class="mt-2 py-1 border border-black p-2  focus:ring-gray-500 focus:border-gray-500 block w-full shadow-lg xl:text-xl  border-black-400 bg-gray-200 px-36"></select>
                    </div>
                </div>
                ...
                <div className='flex space-x-8 py-4 opacity-70'>
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <select type="text" name="first_name" id="first_name" autocomplete="given-name" placeholder="Medium" class="mt-2 py-1 border border-black p-2 focus:ring-gray-500 focus:border-gray-500 block w-full shadow-lg xl:text-xl  border-black-400 bg-gray-200 px-36"></select>
                    </div>

                    <div class="col-span-6 sm:col-span-3">
                        <label for="last_name" class="block text-sm  font-medium text-gray-700">Date Created</label>
                        <input type="date" class="mt-2 py-1 border border-black p-2  focus:ring-gray-500 focus:border-gray-500 block w-full shadow-lg xl:text-xl  border-black-400 bg-gray-200 "></input>
                    </div>
                </div>
                ...
                <div className='flex space-x-8 py-4 opacity-70'>
                    ...
                    <div class="col-span-6 sm:col-span-3 ">
                        ...
                        <textarea type="text"  class="mt-2 py-1 border border-black p-2  focus:ring-gray-500 focus:border-gray-500 block w-full h-20 shadow-lg xl:text-xl  border-black-400 bg-gray-200 px-35"></textarea>
                    </div>
                </div>
